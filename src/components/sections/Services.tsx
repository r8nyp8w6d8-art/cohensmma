      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-body-lg text-muted-foreground max-w-2xl mx-auto animate-fade-in-up animate-fade-in-delay-1">
            הכל מתחיל מאסטרטגיה ברורה ומסתיים בביצוע חד. אנחנו לא מייעצים – אנחנו מבצעים.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          {services.map((service, index) => (
            <div 
              key={service.title}
              className="group p-6 bg-card rounded-xl border border-border hover:border-primary/30 card-hover animate-fade-in-up"
