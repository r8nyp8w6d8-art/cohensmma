...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 py-24 bg-background">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-body-lg text-muted-foreground mb-4 animate-fade-in-up animate-fade-in-delay-1">
